...
const Login = () => {
  ...
  // Show session expiry warning toast if redirected
  React.useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!emailOrUsername || !password) {
      return toast.error('Please enter your account credentials');
    }
  ...
  const handleDemoBypass = async () => {
    setSubmitting(true);
    // Directly logs user in with mock data
      ...
      <div className="w-full max-w-md space-y-8 relative">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-textSecondary">
            Sign in to continue your personalized study workflow.
          </p>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:border-brandPrimary focus:ring-1 focus:ring-brandPrimary text-sm text-textPrimary placeholder-textSecondary/50 transition outline-none"
                />
              </div>
            </div>
        ...
        <p className="text-center text-xs text-textSecondary">
          ...
          <Link to="/register" className="text-brandPrimary hover:underline font-semibold">
            Register for free
          </Link>
        </p>
